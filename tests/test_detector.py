...
def test_v2_config_is_normalized():
    ...
    assert cfg['sources'] == {'wallfast': {'enabled': True, 'interval_seconds': 15, 'exclude_areas': [], 'include_areas': []},
                              'wahlin': {'enabled': False, 'interval_seconds': 300, 'exclude_areas': [], 'include_areas': []}}
